...
This page provides information about contributing to Plugin Health Scoring code base.

== Getting started

The project is using Maven with Java 17 and Yarn to be built.
The entire build process can be handled by Maven.
Yarn build will bundle the front-end files only.
...
. In GitHub Web UI, click the _New pull request_ button.
